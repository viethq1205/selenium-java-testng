...
public class Topic_04_Data_Provider {
    ...
    public void TC_01_LoginToSystem(String username, String password) {
            ...
            //rồi logout (ở dưới có 3 bộ đăng nhập nên phải out ra để bộ thứ 2 login vào, lặp lại lần nữa tương tự với thứ 3)
            driver.findElement(By.xpath("//header[@id='header']//span[text()='Account']")).click();
            driver.findElement(By.xpath("//a[text()='Log Out']")).click();
    }

    @DataProvider(name = "user_pass") //thằng @dataprovider này có thể tạo nhiều cái
